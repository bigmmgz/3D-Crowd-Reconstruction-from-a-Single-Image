...
class MuPoTs(torch.utils.data.Dataset):
    def __init__(self):
        ...
        self.img_dir = osp.join('..', 'data', 'MSCOCO', 'data', 'MultiPersonTestSet')
        self.test_annot_path = osp.join('..', 'data', 'MuPoTs', 'data', 'MSCOCO-3D.json')
        ...
        self.mmpose_joints_name = ('Nose', 'Thorax', 'R_Shoulder', 'R_Elbow', 'R_Wrist', 'L_Shoulder', 'L_Elbow', 'L_Wrist', 'R_Hip', 'R_Knee', 'R_Ankle', 'L_Hip',  'L_Knee', 'L_Ankle', 'R_Eye', 'L_Eye', 'R_Ear',  'L_Ear')
    ...
    # input image
        ...
        pose_estimator = init_pose_estimator(
            'configs/body_2d_keypoint/topdown_heatmap/coco/lite_hrnet-30-coordattention_epoch280.py',
            'litehrnet30_coordination_300epoch.pth',
            device=device,
...
class PoseMatcher:
    def __init__(self, dataloader):
        ...
        result_path = '/home/xiaohansun/projects/lite_hrnet-30-coordattention_epoch280'  
...
def save_output(output):
    save_file_name = f'test_result.json'
